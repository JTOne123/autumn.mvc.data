...
namespace GgTools.DataREST.Mvc
{
    public class PageableModelBinderProvider : IModelBinderProvider
    {
        ...
        {
            _pageSizeField = configuration.GetSection("Ggtools.DataREST.Settings:Pageable_PageSize_Name").Value ?? "PageSize";
            _pageNumberField = configuration.GetSection("Ggtools.DataREST.Settings:Pageable_PageNumber_Name").Value ?? "PageNumber";
            _sortField = configuration.GetSection("Ggtools.DataREST.Settings:Pageable_Sort_Name").Value ?? "Sort";
