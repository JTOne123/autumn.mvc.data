...
namespace Autumn.Mvc.Data.Configurations
{
    public class AutumnSettingsBuilder
    {
        ...
        public AutumnSettingsBuilder PageSizeFieldName(string parameterName,
            int? pageSize = null)
        {
            AutumnSettings.Current.PageSizeFieldName = parameterName ?? AutumnSettings.Current.PageSizeFieldName;
        ...
        {
            AutumnSettings.Current.PageNumberFieldName = parameterName ?? AutumnSettings.Current.PageNumberFieldName;
            return this;
        }

        public AutumnSettingsBuilder SortFieldName(string parameterName)
        {
            AutumnSettings.Current.SortFieldName = parameterName ?? AutumnSettings.Current.SortFieldName;
            return this;
        }
        
        public AutumnSettingsBuilder QueryFieldName(string parameterName)
        {
            AutumnSettings.Current.QueryFieldName = parameterName ?? AutumnSettings.Current.QueryFieldName;
            return this;
        }
